...
- **Script**: `src/train.py fiber=basic`
- **Dataset**: `STL10`
- **Image size**: 96
- **Patch size**: 32
- **Epochs**: 200
- **Batch size**: 64
- **Subset**:
  - train: 5000 (default; not explicitly passed in the override list)
  - test: 64
...
Fiber diagnostics are computed and saved at the same checkpoint cadence as `fiber.embed_interval` (here: every 10 epochs, stored as epochs `0, 9, 19, ..., 199`). To match the “every 20 epochs” reporting style, we sample the closest available checkpoint epochs: `0, 19, 39, ..., 199`.
...
| | | | |
|---|---|---|---|
| <img src="imgs/embeddings/irregular_samples_241_88e58f05a40572feee76.png" width="260"><br><sub>token 99, class airplane, pred truck, patch_pred airplane, dim 5.87, neigh 11.53, img_mean 10.78, irr 3.63</sub> | <img src="imgs/embeddings/irregular_samples_241_8b5f4bf7369cf4aa6710.png" width="260"><br><sub>token 173, class horse, pred dog, patch_pred truck, dim 15.35, neigh 11.68, img_mean 11.10, irr 3.63</sub> | <img src="imgs/embeddings/irregular_samples_241_bef125e35f62ca152853.png" width="260"><br><sub>token 356, class dog, pred truck, patch_pred monkey, dim 23.15, neigh 11.73, img_mean 13.15, irr 3.68</sub> | <img src="imgs/embeddings/irregular_samples_241_3075500680d1bd160616.png" width="260"><br><sub>token 26, class dog, pred dog, patch_pred airplane, dim 10.85, neigh 11.63, img_mean 11.65, irr 3.64</sub> |
| <img src="imgs/embeddings/irregular_samples_241_860c5275f278f4a95f98.png" width="260"><br><sub>token 381, class airplane, pred airplane, patch_pred airplane, dim 15.34, neigh 11.64, img_mean 6.98, irr 3.67</sub> | <img src="imgs/embeddings/irregular_samples_241_205dcee0bcbdce389067.png" width="260"><br><sub>token 154, class truck, pred truck, patch_pred car, dim 11.51, neigh 11.45, img_mean 11.88, irr 3.70</sub> | <img src="imgs/embeddings/irregular_samples_241_ddb9681fda876f67751c.png" width="260"><br><sub>token 250, class dog, pred monkey, patch_pred airplane, dim 9.06, neigh 11.57, img_mean 13.19, irr 3.70</sub> | <img src="imgs/embeddings/irregular_samples_241_712664d132387b105c0f.png" width="260"><br><sub>token 484, class airplane, pred airplane, patch_pred airplane, dim 2.52, neigh 11.57, img_mean 6.27, irr 3.76</sub> |
| <img src="imgs/embeddings/irregular_samples_241_04ab529252386e4f3177.png" width="260"><br><sub>token 166, class airplane, pred airplane, patch_pred car, dim 7.28, neigh 11.83, img_mean 8.21, irr 3.83</sub> | <img src="imgs/embeddings/irregular_samples_241_56a2323f2beda2a73e0c.png" width="260"><br><sub>token 405, class truck, pred car, patch_pred car, dim 9.81, neigh 11.53, img_mean 9.02, irr 4.18</sub> | <img src="imgs/embeddings/irregular_samples_241_0ed7bbf7e4f0a1fd4e8e.png" width="260"><br><sub>token 27, class airplane, pred airplane, patch_pred airplane, dim 6.15, neigh 11.53, img_mean 9.94, irr 4.03</sub> | <img src="imgs/embeddings/irregular_samples_241_24fa7e397a114f352cf9.png" width="260"><br><sub>token 537, class airplane, pred ship, patch_pred airplane, dim 25.02, neigh 11.62, img_mean 11.50, irr 4.41</sub> |
